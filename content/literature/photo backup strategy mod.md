...
CM selectively syncs some folders in LrC to Lr mobile (iPad) to do some iPad edits then he finishes at LrC.

An alternative to a third cull might be the using of ratings. A third cull could be rating photos a three. A fourth cull could be rating photos a five.

CM choices at least one photo to represent a segment of the walk/ride.

Culling
1. Cull 1
2. 3 star - liberal choices
3. 5 star - favorites
4. 4 star - not too favorites

Seagate iron wolves (?) for hard drives (highest rated + reasonable price)
10 TB
