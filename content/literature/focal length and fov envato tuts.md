...
- It is the length in MM between the optical center of the lens to your camera's sensor when the lens is focused at infinity.
- Determines how much of the world in front of your camera can you fit in your sensor.
- Determines how much of the world you will be able to see from your current position.
- Not a description of how long or short a lens is physically.

What is the optical center of a camera's lens?
- The point where all light rays intersect inside the lens.

How does focal length relate to what you see in a camera?
- Determines a lens' FOV and thus how much the subject will be magnified or reduced from a position.
...
- But it should be called equivalent field of view. Because the 50 mm lens did not change its focal length when mounted on an APS-C camera. What changes is the crop and the equivalent FOV.
- A 50 mm lens on an APS-C camera is similar to an 80 mm lens FOV on a full frame camera.
...
<!--SR:!2026-10-08,257,250-->

Shorter focal length = ==wider== FOV.
<!--SR:!2026-11-19,115,230-->

Longer focal length = ==narrow== FOV.
<!--SR:!2028-03-28,622,250-->
...
<!--SR:!2027-02-05,411,290-->

APS-C has an FOVCF of ==1.5x== for Nikon.
<!--SR:!2026-11-07,142,270-->
...
_What Every Photographer Should Know About Lenses: Focal Length and Field-of-View_. Directed by Envato Tuts+, 2014. _YouTube_, [https://www.youtube.com/watch?v=1kAVGQvYGEw](https://www.youtube.com/watch?v=1kAVGQvYGEw).