...
The [[self]] moves away from this process and through its thoughts and [[action|actions]] make it appear as if it is separate. But it isn't. And so the returning to one is the act of remembering and ministry is work to help us return to one easier. The work is to remember this every day and help others remember, too. The remembering, I think, involves [[faith]] and is faith.

Because to remember that there exists an incomprehensible process in the universe from where we were borne out of should, I think, naturally move one to trust in that process and to have faith in it. The faith unites the self with the process and collapses the self. And in [[jodo shinshu|Jōdo Shinshū]], one doesn't have to meditate oneself into this. Pure recognition is enough: "I am one with this process."

[[bathala nawa|"Bathala nawa"]].