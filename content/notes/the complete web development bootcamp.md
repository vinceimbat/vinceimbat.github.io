...
created: 2026-07-16T10:43:40+08:00
modified: 2026-07-16T10:44:12+08:00
aliases:
draft: false
tags:
  - species/thought
...
4. Take notes using the cornell note-taking system:
   5. Write the title of the lesson.
   6. Write notes.
   7. Write questions based on the notes.
   8. Write a summary of the lesson.
9. If you are struggling with a particular topic, bookmark it, leave it for a while, then come back to it later.
10. When stuck, use Google and stackoverflow.

# How to get help when you're stuck

1. Define the expectation vis a vis the reality.
   2. What did you expect your code will do?
   3. What did it actually do?
4. Then look for what caused the difference.
5. Paste the error messages in Google.
6. If there are results from stack overflow, look at those.
7. Rewatch the videos, you may have made a mistake right before your code went wrong.
8. Check your code against the code you are copying.
9. Use the Q&A section in indivudal videos. Include the timestamp.
...
1. <head></head> : Holds information about the webpage; tells the browser how it should handle the page
   2. <meta charset="utf-8"> : Tells the browser that the content of the page is encoded using utf-8 system. If a browser interprets a page using a wrong encoding system, it generates a mojibake.
   3. <title></title> : Tells the browser the title of the page
4. <body></body>
