...
1. Write [[fleeting notes]]. You can also write permanent notes directly into the zettelkasten.
...
4. Format these notes to be understandable by your future self:
   - Write one idea per note.
   - Use full sentences.
   - Indicate your references.
   - Be brief and clear.
5. After processing the fleeting notes, throw them away. After processing literature notes, return them to your reference system.
6. Add links. In each new permanent note, add links to related notes, to the index, or to an entry point linked to the index.
