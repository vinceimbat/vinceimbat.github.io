...
- I will no longer take on a website design and development client. I have no mental space for it, not enough skill to pull it off, and just involves too much work.
- I will no longer take on writing jobs from Filipino clients unless it will be great for my portfolio.
- I may or may not continue learning how to be a better editor.
- Although I now rely entirely on Bookbright, I want to establish more resilience by exploring some side hustles.
...
- Use poetry to explore my religious past and present ala Merton.
- Learn short Japanese forms like haiku, senryu, etc.
- Practice methods taught by Olson, Ginsberg, Trungpa, Levertov, etc.
- Focus on writing poetry in English and Pangasinan.
...
- Calls match existing writing that I know I want to improve.
- I want to use them as deadlines to make progress in existing writing projects. The goal is not to get in but to finish work.
- Workshops are not connected with scandals or are aligned with my values.
...
- A book about LB written in Filipino and signifying my creation of my jiyū shūkyō.
- A book about Baguio written in English, recounting my life as a JW minister.
- A book about Pangasinan written in Pangasinan, with a goal more secular (actually still unsure).
- A book of poems formatted as a liturgy.
...
- However, writing will take a secondary and new role in relation to my jiyū shūkyō, which is now the central gravity of my life.
- I will prioritize building a community around my writing, and producing works that inspire and educate that community. Building a community around my writing and writing life encourages me to move away from the more ego-driven model of writing that emphasizes workshops, contests, and publications (WOP). Being published, winning in contests, or being workshopped are no longer as important as being part of a community. My goal moving forward is to make my writing kyokai-focused where it becomes a way to serve a sangha by teaching or inspiring. My writing life now is in the service of the whole—not of my self.
- I wanted to be more intentional in the art I release. If it isn't lyrical philosophy in the jiyū shūkyō tradition or if it isn't spiritual writing, I won't release it. This means I won't be sending works to publication calls if they don't fit right.
- I will focus on my religious studies, contemplation, and application and content myself with the writing that flows naturally from these primary activities. I have to focus on this process and let go of anything that will disturb it.
- Since I will be focusing on my religious studies, contemplation, and application, I will focus on private forms of writing like journaling, note-taking, and poetry.
- My public writing should flow out naturally from my studies, contemplation, and daily application.
- I could no longer waste my time responding on other people's calls. I will focus on my religious calling and my own writing projects that flow from that calling.
- Moving forward, I will continue to use writing to resolve my religious past and to construct my religious present. There is so much material in both.
- I want to produce lyrical philosophy—beautifully crafted pieces of writing that inspires or educates one to provoke them to think about the Great Life and their place in it.
- Given that I want writing to be a tool to experience life more fully and experience community more fully, I will be as open and welcoming as possible to the writings of others, especially those part of my community. My goal is to immerse myself in a forest of moments.
...
- WHAT I WANT IS MY RETURN TO READING, CONTEMPLATING, AND THEN WHEN NECESSARY WRITING. BUT I NEED TO RETURN TO THAT THINKING ABOUT BIG THINGS MODE.
- Establish a natural progression from studies, contemplation, etc. to journaling to newsletter.
- What to produce: Honest and earnest autobiographical writing, similar style but poems