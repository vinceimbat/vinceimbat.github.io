...
1. Determine my general progress in projects and areas by reviewing all [[daily review]] reports and entries in the [[index of my journals]] for the past month to create a [[monthly reports|monthly report]].
...
4. Review [[my lifeview]].
5. Review [[my workview]].
6. Review my [[personal narrative vision]] for the year.
   - Bold parts that could be addressed with new projects.
   - Highlight parts that fit more into [[life area|life areas]].
   - Code-format parts that have been achieved.
   - Put a "(?)" at the end of projects that may be dropped or postponed for the next year.
5. Review and update [[my life goals master list]] (refer to [[how to set goals]]).
   ...
   - If the Primary Focus list is empty or lacking at least one of five goals, review the five goals under the Next list and promote goals to Primary Focus.
   - Update timelines for chosen goals for the month.
   - Update wording or definition of the goals.
   - Promote goals from Avoid At All Cost to Next if necessary.
   - Add new goals if necessary.
6. Review and update the Project List.
